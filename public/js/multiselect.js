...
function init(element) {
    ...
    const dropdown_icon = document.createElement("button"); // a -> button
...
function createToken(wrapper, value) {
    ...
    const close = document.createElement("button"); // a -> button
...
function deletePressed(e) {
    ...
    if (tokens.length) {
        const last_token_x = tokens[tokens.length - 1].querySelector("a"); // suspect
